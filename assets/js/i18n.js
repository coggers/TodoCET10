...
const STRINGS = {
  ca: {
    ...
    privacySections: [
      ...
      ['Comentaris',
       'Si obres el formulari de comentaris, es carrega hCaptcha (Intuition Machines) per aturar el correu brossa; només llavors, mai en obrir l’app. Si envies comentaris, el missatge que escrius, el correu opcional que hi posis i l’idioma triat s’envien a Web3Forms, que els fa arribar per correu electrònic. Web3Forms desa els enviaments fins a 30 dies, en servidors dels Estats Units, i l’empresa opera des de l’Índia: per tant, aquesta informació surt de l’EEE. Només es fa servir per llegir i respondre el teu missatge. Si us plau, no hi incloguis res sensible.'],
      ...
      ['Sense seguiment',
       'No hi ha analítica, ni publicitat, ni seguiment, ni perfilat, i cap tercer no rep res tret que obris el formulari de comentaris. En obrir-lo es carrega hCaptcha, que pot desar una galeta pròpia per distingir persones de robots; és l’única galeta de tot el lloc. Res del que fas aquí es mesura ni se’ns envia. Per això no hi ha cap avís de consentiment: les preferències les tries tu, i la comprovació antispam només s’executa en un formulari que has decidit obrir.'],
      ['Els teus drets',
    ...
    feedbackCaptcha: 'Confirma que no ets un robot abans d’enviar.',
  ...
  es: {
    ...
    privacySections: [
      ...
      ['Comentarios',
       'Si abres el formulario de comentarios, se carga hCaptcha (Intuition Machines) para frenar el spam; solo entonces, nunca al abrir la app. Si envías comentarios, el mensaje que escribes, el correo opcional que indiques y el idioma elegido se envían a Web3Forms, que los entrega por correo electrónico. Web3Forms guarda los envíos hasta 30 días, en servidores de Estados Unidos, y la empresa opera desde India: por tanto, esta información sale del EEE. Solo se usa para leer y responder tu mensaje. Por favor, no incluyas nada sensible.'],
      ...
      ['Sin seguimiento',
       'No hay analítica, ni publicidad, ni seguimiento, ni perfilado, y ningún tercero recibe nada salvo que abras el formulario de comentarios. Al abrirlo se carga hCaptcha, que puede guardar una cookie propia para distinguir personas de robots; es la única cookie de todo el sitio. Nada de lo que haces aquí se mide ni se nos envía. Por eso no hay aviso de consentimiento: las preferencias las eliges tú, y la comprobación antispam solo se ejecuta en un formulario que has decidido abrir.'],
      ['Tus derechos',
    ...
    feedbackCaptcha: 'Confirma que no eres un robot antes de enviar.',
  ...
  en: {
    ...
    privacySections: [
      ...
      ['No tracking',
       'There is no analytics, no advertising, no tracking and no profiling, and no third party hears from you at all unless you open the feedback form. Opening it loads hCaptcha, which may set a cookie of its own to tell people from bots; that is the only cookie on the whole site. Nothing you do in this app is measured or sent to us. That is why there is no consent banner: the preferences are ones you set yourself, and the spam check only runs on a form you chose to open.'],
      ['Your rights',
    ...
    feedbackCaptcha: 'Please confirm you are not a robot before sending.',
