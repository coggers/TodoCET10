...
const STRINGS = {
  ca: {
    ...
    privacySections: [
      ...
      ['Sense seguiment',
       'No hi ha analítica, ni publicitat, ni seguiment, ni perfilat, ni galetes, i cap tercer no rep res tret que obris el formulari de comentaris. Res del que fas aquí es mesura ni se’ns envia. Per això no hi ha cap avís de consentiment: l’únic que es desa al teu dispositiu són les preferències que tries tu, que no requereixen consentiment.'],
      ['Els teus drets',
  ...
  es: {
    ...
    privacySections: [
      ...
      ['Sin seguimiento',
       'No hay analítica, ni publicidad, ni seguimiento, ni perfilado, ni cookies, y ningún tercero recibe nada salvo que abras el formulario de comentarios. Nada de lo que haces aquí se mide ni se nos envía. Por eso no hay aviso de consentimiento: lo único que se guarda en tu dispositivo son las preferencias que eliges tú, que no requieren consentimiento.'],
      ['Tus derechos',
  ...
  en: {
    ...
    privacySections: [
      ...
      ['No tracking',
       'There is no analytics, no advertising, no tracking, no profiling and no cookies, and no third party hears from you at all unless you open the feedback form. Nothing you do in this app is measured or sent to us. That is why there is no consent banner: the only things stored on your device are the preferences you set yourself, which do not require consent.'],
      ['Your rights',
